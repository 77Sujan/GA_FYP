...
class Data:
    ...
    def __init__(self):
        ...
        course1 = Course("AI", "C1", [self._instructors[0]], 80)
        course2 = Course("Big Data", "C2", [self._instructors[1]], 80)
        course3 = Course("PP", "C3", [self._instructors[2], self._instructors[3]], 80)
        course4 = Course("HPC", "C4", [self._instructors[4]], 80)
        course5 = Course("CS", "C5", [self._instructors[5], self._instructors[0]], 80)
        self._courses = [course1, course2, course3, course4, course5]

        dept1 = Department("Sem 5", [course4, course5])
        dept2 = Department("Sem 6", [course1, course2, course3])
        self._depts = [dept1, dept2]

        self._noOfClasses = 0
        for i in range(0, len(self._depts)):
            self._noOfClasses += len(self._depts[i].get_courses())
...
class Schedule:
    ...
    def calculate_fitness(self):
        ...
        for i in range(0, len(classes)):
            if (classes[i].get_room().get_seatingCapacity() < classes[i].get_course().get_maxNumberOfStudent()):
...
class Course:
    def __int__(self, name, number, instructors, maxnumber):
        self._name = name
        self._number = number
    ...
    def get_maxnumber(self): return self._maxnumber
...
class Room:
    def __int__(self, number, capacity):
        self._number = number
...
class DisplayMgr:
    ...
    def print_course(self):
        ...
        for i in range(0, len(courses)):
            ...
            availableCoursesTable.add_row(
                [courses[i].get_number(), courses[i].get_name(), str(courses[i].get_maxnumber()), tempStr])
    ...
    def print_room(self):
        availableRoomsTable = prettytable.PrettyTable(['room #', 'Max capacity'])
    ...
    def print_generation(self, population):
        ...
        for i in range(0, len(schedules)):
            table1.add_row([str(i), round(schedules[i].get_fitness(), 3), schedules[i].get_numberOfConflicts(),
    ...
    def print_schedule_as_table(self, schedule):
        ...
        table = prettytable.PrettyTable(
            ['Class #', 'Dept', 'Course (Number + max # of student)', 'Room', 'Instructor', 'Meeting Time'])
        for i in range(0, len(classes)):
